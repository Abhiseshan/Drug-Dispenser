...
SIGNAL \Sc|counter[1]~0_combout\ : std_logic;
...
SIGNAL \H|hours[4]~1_combout\ : std_logic;
SIGNAL \setT|outHours~0_combout\ : std_logic;
SIGNAL \setT|outHours[2]~1_combout\ : std_logic;
SIGNAL \setT|outHours~2_combout\ : std_logic;
SIGNAL \setT|outHours~3_combout\ : std_logic;
SIGNAL \H|hours~7_combout\ : std_logic;
SIGNAL \setT|outHours[2]~4_combout\ : std_logic;
SIGNAL \H|hours[4]~4_combout\ : std_logic;
...
SIGNAL \H|hours[4]~2_combout\ : std_logic;
...
SIGNAL \H|ALT_INV_hours[4]~4_combout\ : std_logic;
SIGNAL \setT|ALT_INV_outHours[2]~4_combout\ : std_logic;
SIGNAL \H|ALT_INV_hours[4]~2_combout\ : std_logic;
...
\H|ALT_INV_hours[4]~4_combout\ <= NOT \H|hours[4]~4_combout\;
\setT|ALT_INV_outHours[2]~4_combout\ <= NOT \setT|outHours[2]~4_combout\;
\H|ALT_INV_hours[4]~2_combout\ <= NOT \H|hours[4]~2_combout\;
...
-- Equation(s):
-- \FSMClk|currentstate~12_combout\ = ( \FSMClk|currentstate.setMode~q\ & ( (!\SW[9]~input_o\ & (!\FSMClk|currentstate.preSetMode~q\ & \KEY[0]~input_o\)) ) )
...
-- Equation(s):
-- \setT|bpt|Add0~45_sumout\ = SUM(( \setT|bpt|counter\(2) ) + ( GND ) + ( \setT|bpt|Add0~26\ ))
-- \setT|bpt|Add0~46\ = CARRY(( \setT|bpt|counter\(2) ) + ( GND ) + ( \setT|bpt|Add0~26\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~69_sumout\ = SUM(( \setT|bpt|counter\(3) ) + ( GND ) + ( \setT|bpt|Add0~46\ ))
-- \setT|bpt|Add0~70\ = CARRY(( \setT|bpt|counter\(3) ) + ( GND ) + ( \setT|bpt|Add0~46\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~65_sumout\ = SUM(( \setT|bpt|counter\(4) ) + ( GND ) + ( \setT|bpt|Add0~70\ ))
-- \setT|bpt|Add0~66\ = CARRY(( \setT|bpt|counter\(4) ) + ( GND ) + ( \setT|bpt|Add0~70\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~61_sumout\ = SUM(( \setT|bpt|counter\(5) ) + ( GND ) + ( \setT|bpt|Add0~66\ ))
-- \setT|bpt|Add0~62\ = CARRY(( \setT|bpt|counter\(5) ) + ( GND ) + ( \setT|bpt|Add0~66\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~57_sumout\ = SUM(( \setT|bpt|counter\(6) ) + ( GND ) + ( \setT|bpt|Add0~62\ ))
-- \setT|bpt|Add0~58\ = CARRY(( \setT|bpt|counter\(6) ) + ( GND ) + ( \setT|bpt|Add0~62\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~53_sumout\ = SUM(( \setT|bpt|counter\(7) ) + ( GND ) + ( \setT|bpt|Add0~58\ ))
-- \setT|bpt|Add0~54\ = CARRY(( \setT|bpt|counter\(7) ) + ( GND ) + ( \setT|bpt|Add0~58\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~49_sumout\ = SUM(( \setT|bpt|counter\(8) ) + ( GND ) + ( \setT|bpt|Add0~54\ ))
-- \setT|bpt|Add0~50\ = CARRY(( \setT|bpt|counter\(8) ) + ( GND ) + ( \setT|bpt|Add0~54\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~41_sumout\ = SUM(( \setT|bpt|counter\(9) ) + ( GND ) + ( \setT|bpt|Add0~50\ ))
-- \setT|bpt|Add0~42\ = CARRY(( \setT|bpt|counter\(9) ) + ( GND ) + ( \setT|bpt|Add0~50\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~37_sumout\ = SUM(( \setT|bpt|counter\(10) ) + ( GND ) + ( \setT|bpt|Add0~42\ ))
-- \setT|bpt|Add0~38\ = CARRY(( \setT|bpt|counter\(10) ) + ( GND ) + ( \setT|bpt|Add0~42\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~33_sumout\ = SUM(( \setT|bpt|counter\(11) ) + ( GND ) + ( \setT|bpt|Add0~38\ ))
-- \setT|bpt|Add0~34\ = CARRY(( \setT|bpt|counter\(11) ) + ( GND ) + ( \setT|bpt|Add0~38\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~29_sumout\ = SUM(( \setT|bpt|counter\(12) ) + ( GND ) + ( \setT|bpt|Add0~34\ ))
-- \setT|bpt|Add0~30\ = CARRY(( \setT|bpt|counter\(12) ) + ( GND ) + ( \setT|bpt|Add0~34\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~17_sumout\ = SUM(( \setT|bpt|counter\(13) ) + ( GND ) + ( \setT|bpt|Add0~30\ ))
-- \setT|bpt|Add0~18\ = CARRY(( \setT|bpt|counter\(13) ) + ( GND ) + ( \setT|bpt|Add0~30\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~1_sumout\ = SUM(( \setT|bpt|counter\(17) ) + ( GND ) + ( \setT|bpt|Add0~6\ ))
-- \setT|bpt|Add0~2\ = CARRY(( \setT|bpt|counter\(17) ) + ( GND ) + ( \setT|bpt|Add0~6\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~121_sumout\ = SUM(( \setT|bpt|counter\(18) ) + ( GND ) + ( \setT|bpt|Add0~2\ ))
-- \setT|bpt|Add0~122\ = CARRY(( \setT|bpt|counter\(18) ) + ( GND ) + ( \setT|bpt|Add0~2\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~117_sumout\ = SUM(( \setT|bpt|counter\(19) ) + ( GND ) + ( \setT|bpt|Add0~122\ ))
-- \setT|bpt|Add0~118\ = CARRY(( \setT|bpt|counter\(19) ) + ( GND ) + ( \setT|bpt|Add0~122\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~113_sumout\ = SUM(( \setT|bpt|counter\(20) ) + ( GND ) + ( \setT|bpt|Add0~118\ ))
-- \setT|bpt|Add0~114\ = CARRY(( \setT|bpt|counter\(20) ) + ( GND ) + ( \setT|bpt|Add0~118\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~109_sumout\ = SUM(( \setT|bpt|counter\(21) ) + ( GND ) + ( \setT|bpt|Add0~114\ ))
-- \setT|bpt|Add0~110\ = CARRY(( \setT|bpt|counter\(21) ) + ( GND ) + ( \setT|bpt|Add0~114\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~105_sumout\ = SUM(( \setT|bpt|counter\(22) ) + ( GND ) + ( \setT|bpt|Add0~110\ ))
-- \setT|bpt|Add0~106\ = CARRY(( \setT|bpt|counter\(22) ) + ( GND ) + ( \setT|bpt|Add0~110\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~101_sumout\ = SUM(( \setT|bpt|counter\(23) ) + ( GND ) + ( \setT|bpt|Add0~106\ ))
-- \setT|bpt|Add0~102\ = CARRY(( \setT|bpt|counter\(23) ) + ( GND ) + ( \setT|bpt|Add0~106\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~97_sumout\ = SUM(( \setT|bpt|counter\(24) ) + ( GND ) + ( \setT|bpt|Add0~102\ ))
-- \setT|bpt|Add0~98\ = CARRY(( \setT|bpt|counter\(24) ) + ( GND ) + ( \setT|bpt|Add0~102\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~93_sumout\ = SUM(( \setT|bpt|counter\(25) ) + ( GND ) + ( \setT|bpt|Add0~98\ ))
-- \setT|bpt|Add0~94\ = CARRY(( \setT|bpt|counter\(25) ) + ( GND ) + ( \setT|bpt|Add0~98\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~89_sumout\ = SUM(( \setT|bpt|counter\(26) ) + ( GND ) + ( \setT|bpt|Add0~94\ ))
-- \setT|bpt|Add0~90\ = CARRY(( \setT|bpt|counter\(26) ) + ( GND ) + ( \setT|bpt|Add0~94\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~85_sumout\ = SUM(( \setT|bpt|counter\(27) ) + ( GND ) + ( \setT|bpt|Add0~90\ ))
-- \setT|bpt|Add0~86\ = CARRY(( \setT|bpt|counter\(27) ) + ( GND ) + ( \setT|bpt|Add0~90\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~81_sumout\ = SUM(( \setT|bpt|counter\(28) ) + ( GND ) + ( \setT|bpt|Add0~86\ ))
-- \setT|bpt|Add0~82\ = CARRY(( \setT|bpt|counter\(28) ) + ( GND ) + ( \setT|bpt|Add0~86\ ))
...
-- Equation(s):
-- \setT|bpt|Add0~77_sumout\ = SUM(( \setT|bpt|counter\(29) ) + ( GND ) + ( \setT|bpt|Add0~82\ ))
-- \setT|bpt|Add0~78\ = CARRY(( \setT|bpt|counter\(29) ) + ( GND ) + ( \setT|bpt|Add0~82\ ))
...
-- Equation(s):
-- \setT|bpt|Equal0~3_combout\ = ( !\setT|bpt|counter\(28) & ( !\setT|bpt|counter\(26) & ( (!\setT|bpt|counter\(29) & (!\setT|bpt|counter\(24) & (!\setT|bpt|counter\(25) & !\setT|bpt|counter\(27)))) ) ) )
...
PORT MAP (
	...
	datac => \setT|bpt|ALT_INV_counter\(25),
	datad => \setT|bpt|ALT_INV_counter\(27),
...
-- Equation(s):
-- \setT|bpt|Equal0~4_combout\ = ( !\setT|bpt|counter\(18) & ( !\setT|bpt|counter\(22) & ( (\setT|bpt|counter\(20) & (\setT|bpt|counter\(23) & (!\setT|bpt|counter\(21) & \setT|bpt|counter\(19)))) ) ) )
...
-- Equation(s):
-- \setT|bpt|Equal0~1_combout\ = ( \setT|bpt|counter\(9) & ( \setT|bpt|counter\(10) & ( (!\setT|bpt|counter\(11) & (\setT|bpt|counter\(12) & (!\setT|bpt|counter\(8) & \setT|bpt|counter\(2)))) ) ) )
...
-- Equation(s):
-- \setT|bpt|Equal0~2_combout\ = ( \setT|bpt|counter\(4) & ( !\setT|bpt|counter\(7) & ( (\setT|bpt|counter\(3) & (!\setT|bpt|counter\(30) & (\setT|bpt|counter\(5) & \setT|bpt|counter\(6)))) ) ) )
...
PORT MAP (
	...
	datab => \setT|bpt|ALT_INV_counter\(30),
...
-- Equation(s):
-- \setT|bpt|Equal0~0_combout\ = ( !\setT|bpt|counter\(16) & ( \setT|bpt|counter\(15) & ( (\setT|bpt|counter\(0) & (!\setT|bpt|counter\(14) & (!\setT|bpt|counter\(13) & \setT|bpt|counter\(1)))) ) ) )
...
-- Equation(s):
-- \setT|bpt|Equal0~5_combout\ = ( \setT|bpt|Equal0~2_combout\ & ( \setT|bpt|Equal0~0_combout\ & ( (\setT|bpt|Equal0~3_combout\ & (\setT|bpt|Equal0~4_combout\ & (\setT|bpt|Equal0~1_combout\ & !\setT|bpt|counter\(17)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \setT|bpt|ALT_INV_Equal0~5_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_currentstate.resetMode~q\,
...
-- Equation(s):
-- \Mc|counter~0_combout\ = ( \FSMClk|update~combout\ & ( \setT|outSeconds\(0) ) ) # ( !\FSMClk|update~combout\ & ( (\KEY[0]~input_o\ & !\Mc|counter\(0)) ) )
...
-- Equation(s):
-- \Sc|Add0~81_sumout\ = SUM(( \Sc|counter\(0) ) + ( VCC ) + ( !VCC ))
-- \Sc|Add0~82\ = CARRY(( \Sc|counter\(0) ) + ( VCC ) + ( !VCC ))
...
\Sc|counter[1]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \Sc|counter[1]~0_combout\ = ( \Sc|Equal0~5_combout\ ) # ( !\Sc|Equal0~5_combout\ & ( !\KEY[0]~input_o\ ) )
...
PORT MAP (
	...
	combout => \Sc|counter[1]~0_combout\);
...
-- Equation(s):
-- \Sc|Add0~77_sumout\ = SUM(( \Sc|counter\(1) ) + ( GND ) + ( \Sc|Add0~82\ ))
-- \Sc|Add0~78\ = CARRY(( \Sc|counter\(1) ) + ( GND ) + ( \Sc|Add0~82\ ))
...
-- Equation(s):
-- \Sc|Add0~1_sumout\ = SUM(( \Sc|counter\(2) ) + ( GND ) + ( \Sc|Add0~78\ ))
-- \Sc|Add0~2\ = CARRY(( \Sc|counter\(2) ) + ( GND ) + ( \Sc|Add0~78\ ))
...
-- Equation(s):
-- \Sc|Add0~37_sumout\ = SUM(( \Sc|counter\(12) ) + ( GND ) + ( \Sc|Add0~42\ ))
-- \Sc|Add0~38\ = CARRY(( \Sc|counter\(12) ) + ( GND ) + ( \Sc|Add0~42\ ))
...
-- Equation(s):
-- \Sc|Add0~85_sumout\ = SUM(( \Sc|counter\(14) ) + ( GND ) + ( \Sc|Add0~34\ ))
-- \Sc|Add0~86\ = CARRY(( \Sc|counter\(14) ) + ( GND ) + ( \Sc|Add0~34\ ))
...
-- Equation(s):
-- \Sc|Add0~89_sumout\ = SUM(( \Sc|counter\(15) ) + ( GND ) + ( \Sc|Add0~86\ ))
-- \Sc|Add0~90\ = CARRY(( \Sc|counter\(15) ) + ( GND ) + ( \Sc|Add0~86\ ))
...
-- Equation(s):
-- \Sc|Add0~93_sumout\ = SUM(( \Sc|counter\(16) ) + ( GND ) + ( \Sc|Add0~90\ ))
-- \Sc|Add0~94\ = CARRY(( \Sc|counter\(16) ) + ( GND ) + ( \Sc|Add0~90\ ))
...
-- Equation(s):
-- \Sc|Add0~97_sumout\ = SUM(( \Sc|counter\(17) ) + ( GND ) + ( \Sc|Add0~94\ ))
-- \Sc|Add0~98\ = CARRY(( \Sc|counter\(17) ) + ( GND ) + ( \Sc|Add0~94\ ))
...
-- Equation(s):
-- \Sc|Add0~29_sumout\ = SUM(( \Sc|counter\(18) ) + ( GND ) + ( \Sc|Add0~98\ ))
-- \Sc|Add0~30\ = CARRY(( \Sc|counter\(18) ) + ( GND ) + ( \Sc|Add0~98\ ))
...
-- Equation(s):
-- \Sc|Add0~101_sumout\ = SUM(( \Sc|counter\(19) ) + ( GND ) + ( \Sc|Add0~30\ ))
-- \Sc|Add0~102\ = CARRY(( \Sc|counter\(19) ) + ( GND ) + ( \Sc|Add0~30\ ))
...
-- Equation(s):
-- \Sc|Add0~117_sumout\ = SUM(( \Sc|counter\(23) ) + ( GND ) + ( \Sc|Add0~114\ ))
-- \Sc|Add0~118\ = CARRY(( \Sc|counter\(23) ) + ( GND ) + ( \Sc|Add0~114\ ))
...
-- Equation(s):
-- \Sc|Add0~121_sumout\ = SUM(( \Sc|counter\(24) ) + ( GND ) + ( \Sc|Add0~118\ ))
-- \Sc|Add0~122\ = CARRY(( \Sc|counter\(24) ) + ( GND ) + ( \Sc|Add0~118\ ))
...
-- Equation(s):
-- \Sc|Add0~53_sumout\ = SUM(( \Sc|counter\(25) ) + ( GND ) + ( \Sc|Add0~122\ ))
-- \Sc|Add0~54\ = CARRY(( \Sc|counter\(25) ) + ( GND ) + ( \Sc|Add0~122\ ))
...
-- Equation(s):
-- \Sc|Add0~57_sumout\ = SUM(( \Sc|counter\(26) ) + ( GND ) + ( \Sc|Add0~54\ ))
-- \Sc|Add0~58\ = CARRY(( \Sc|counter\(26) ) + ( GND ) + ( \Sc|Add0~54\ ))
...
-- Equation(s):
-- \Sc|Add0~61_sumout\ = SUM(( \Sc|counter\(27) ) + ( GND ) + ( \Sc|Add0~58\ ))
-- \Sc|Add0~62\ = CARRY(( \Sc|counter\(27) ) + ( GND ) + ( \Sc|Add0~58\ ))
...
-- Equation(s):
-- \Sc|Add0~65_sumout\ = SUM(( \Sc|counter\(28) ) + ( GND ) + ( \Sc|Add0~62\ ))
-- \Sc|Add0~66\ = CARRY(( \Sc|counter\(28) ) + ( GND ) + ( \Sc|Add0~62\ ))
...
-- Equation(s):
-- \Sc|Add0~69_sumout\ = SUM(( \Sc|counter\(29) ) + ( GND ) + ( \Sc|Add0~66\ ))
-- \Sc|Add0~70\ = CARRY(( \Sc|counter\(29) ) + ( GND ) + ( \Sc|Add0~66\ ))
...
-- Equation(s):
-- \Sc|Add0~73_sumout\ = SUM(( \Sc|counter\(30) ) + ( GND ) + ( \Sc|Add0~70\ ))
...
-- Equation(s):
-- \Sc|Equal0~2_combout\ = ( !\Sc|counter\(29) & ( !\Sc|counter\(30) & ( (!\Sc|counter\(27) & (\Sc|counter\(25) & (!\Sc|counter\(26) & !\Sc|counter\(28)))) ) ) )
...
-- Equation(s):
-- \Sc|Equal0~3_combout\ = ( \Sc|counter\(1) & ( \Sc|counter\(0) & ( (\Sc|counter\(15) & (!\Sc|counter\(16) & (\Sc|counter\(17) & \Sc|counter\(14)))) ) ) )
...
PORT MAP (
	...
	datab => \Sc|ALT_INV_counter\(16),
	datac => \Sc|ALT_INV_counter\(17),
	datad => \Sc|ALT_INV_counter\(14),
	datae => \Sc|ALT_INV_counter\(1),
...
-- Equation(s):
-- \Sc|Equal0~4_combout\ = ( \Sc|counter\(19) & ( \Sc|counter\(22) & ( (\Sc|counter\(21) & (\Sc|counter\(23) & (\Sc|counter\(20) & !\Sc|counter\(24)))) ) ) )
...
-- Equation(s):
-- \Sc|Equal0~1_combout\ = ( !\Sc|counter\(18) & ( !\Sc|counter\(9) & ( (\Sc|counter\(12) & (\Sc|counter\(13) & (!\Sc|counter\(10) & !\Sc|counter\(11)))) ) ) )
...
PORT MAP (
	...
	datad => \Sc|ALT_INV_counter\(11),
	datae => \Sc|ALT_INV_counter\(18),
	dataf => \Sc|ALT_INV_counter\(9),
	combout => \Sc|Equal0~1_combout\);

-- Location: MLABCELL_X87_Y12_N12
\Sc|Equal0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \Sc|Equal0~0_combout\ = ( !\Sc|counter\(7) & ( !\Sc|counter\(8) & ( (\Sc|counter\(3) & (\Sc|counter\(6) & (\Sc|counter\(4) & \Sc|counter\(5)))) ) ) )
...
-- Equation(s):
-- \Sc|Equal0~5_combout\ = ( \Sc|Equal0~1_combout\ & ( \Sc|Equal0~0_combout\ & ( (\Sc|counter\(2) & (\Sc|Equal0~2_combout\ & (\Sc|Equal0~3_combout\ & \Sc|Equal0~4_combout\))) ) ) )
...
PORT MAP (
	...
	datac => \Sc|ALT_INV_Equal0~3_combout\,
...
-- Equation(s):
-- \Mc|Add0~0_combout\ = ( \Mc|counter\(1) & ( \Mc|counter\(0) & ( !\Mc|counter\(3) $ (!\Mc|counter\(2)) ) ) ) # ( !\Mc|counter\(1) & ( \Mc|counter\(0) & ( \Mc|counter\(3) ) ) ) # ( \Mc|counter\(1) & ( !\Mc|counter\(0) & ( \Mc|counter\(3) ) ) ) # ( 
...
-- Equation(s):
-- \Mc|counter~3_combout\ = ( \setT|outSeconds\(3) & ( ((!\Mc|pulse~0_combout\ & (\KEY[0]~input_o\ & \Mc|Add0~0_combout\))) # (\FSMClk|update~combout\) ) ) # ( !\setT|outSeconds\(3) & ( (!\Mc|pulse~0_combout\ & (!\FSMClk|update~combout\ & (\KEY[0]~input_o\ & 
-- \Mc|Add0~0_combout\))) ) )
...
-- Equation(s):
-- \Mc|Add0~2_combout\ = ( \Mc|counter\(0) & ( !\Mc|counter\(4) $ (((!\Mc|counter\(3)) # ((!\Mc|counter\(2)) # (!\Mc|counter\(1))))) ) ) # ( !\Mc|counter\(0) & ( \Mc|counter\(4) ) )
...
-- Equation(s):
-- \Mc|counter~5_combout\ = ( \setT|outSeconds\(4) & ( ((!\Mc|pulse~0_combout\ & (\Mc|Add0~2_combout\ & \KEY[0]~input_o\))) # (\FSMClk|update~combout\) ) ) # ( !\setT|outSeconds\(4) & ( (!\Mc|pulse~0_combout\ & (!\FSMClk|update~combout\ & 
-- (\Mc|Add0~2_combout\ & \KEY[0]~input_o\))) ) )
...
-- Equation(s):
-- \Mc|Add0~1_combout\ = ( \Mc|counter\(1) & ( \Mc|counter\(0) & ( (\Mc|counter\(4) & (\Mc|counter\(3) & \Mc|counter\(2))) ) ) )
...
-- Equation(s):
-- \setT|outSeconds~8_combout\ = ( \Mc|counter\(5) & ( (\setT|outSeconds\(4) & (\setT|outSeconds\(3) & !\KEY[1]~input_o\)) ) ) # ( !\Mc|counter\(5) & ( ((\setT|outSeconds\(4) & \setT|outSeconds\(3))) # (\KEY[1]~input_o\) ) )
...
-- (\Mc|Add0~1_combout\ & !\Mc|pulse~0_combout\))) # (\FSMClk|update~combout\) ) ) ) # ( \Mc|counter\(5) & ( !\setT|outSeconds\(5) & ( (\KEY[0]~input_o\ & (!\Mc|Add0~1_combout\ & (!\Mc|pulse~0_combout\ & !\FSMClk|update~combout\))) ) ) ) # ( !\Mc|counter\(5) 
-- & ( !\setT|outSeconds\(5) & ( (\KEY[0]~input_o\ & (\Mc|Add0~1_combout\ & (!\Mc|pulse~0_combout\ & !\FSMClk|update~combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000000000000010000000000000000010000111111110100000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_KEY[0]~input_o\,
...
-- Equation(s):
-- \Mc|pulse~0_combout\ = ( \Mc|counter\(3) & ( \Mc|counter\(0) & ( (\Mc|counter\(4) & (\Mc|counter\(5) & (\Mc|counter\(1) & !\Mc|counter\(2)))) ) ) )
...
-- (\KEY[0]~input_o\ & !\Mc|pulse~0_combout\)) ) ) ) # ( !\Mc|counter\(1) & ( !\FSMClk|update~combout\ & ( (\Mc|counter\(0) & (\KEY[0]~input_o\ & !\Mc|pulse~0_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000000000010100000000000110011001100110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \Mc|ALT_INV_counter\(0),
...
-- Equation(s):
-- \setT|outSeconds~2_combout\ = ( \setT|outSeconds\(0) & ( \Mc|counter\(1) & ( (!\setT|outSeconds\(1)) # (\KEY[1]~input_o\) ) ) ) # ( !\setT|outSeconds\(0) & ( \Mc|counter\(1) & ( (\setT|outSeconds\(1)) # (\KEY[1]~input_o\) ) ) ) # ( \setT|outSeconds\(0) & 
-- ( !\Mc|counter\(1) & ( (!\KEY[1]~input_o\ & !\setT|outSeconds\(1)) ) ) ) # ( !\setT|outSeconds\(0) & ( !\Mc|counter\(1) & ( (!\KEY[1]~input_o\ & \setT|outSeconds\(1)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000010101010101010100000000001010101111111111111111101010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \setT|outSeconds~7_combout\ = ( \setT|outSeconds\(3) & ( \setT|outSeconds~9_combout\ & ( (((\setT|outSeconds\(0) & \setT|outSeconds\(1))) # (\setT|outSeconds\(4))) # (\KEY[1]~input_o\) ) ) ) # ( !\setT|outSeconds\(3) & ( \setT|outSeconds~9_combout\ & ( 
-- (\setT|outSeconds\(4)) # (\KEY[1]~input_o\) ) ) ) # ( \setT|outSeconds\(3) & ( !\setT|outSeconds~9_combout\ & ( (!\KEY[1]~input_o\ & (\setT|outSeconds\(4) & ((!\setT|outSeconds\(0)) # (!\setT|outSeconds\(1))))) ) ) ) # ( !\setT|outSeconds\(3) & ( 
...
-- Equation(s):
-- \setT|outSeconds[5]~3_combout\ = ( \setT|outSeconds\(5) & ( (\setT|outSeconds\(4) & (!\KEY[1]~input_o\ & (\setT|outSeconds\(3) & !\setT|outSeconds\(2)))) ) )
...
-- Equation(s):
-- \FSMClk|Selector4~0_combout\ = ( \setT|outSeconds\(1) & ( \Mc|counter\(1) & ( (\FSMClk|currentstate.setMode~q\ & (!\FSMClk|currentstate.clockMode~q\ & (!\FSMClk|currentstate.preSetMode~q\ & !\FSMClk|currentstate.updateMode~q\))) ) ) ) # ( 
-- !\setT|outSeconds\(1) & ( \Mc|counter\(1) & ( (!\FSMClk|currentstate.clockMode~q\ & !\FSMClk|currentstate.preSetMode~q\) ) ) ) # ( \setT|outSeconds\(1) & ( !\Mc|counter\(1) & ( (\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.updateMode~q\) ) ) ) 
...
-- Equation(s):
-- \FSMClk|Selector2~0_combout\ = ( \setT|outSeconds\(3) & ( \Mc|counter\(3) & ( (!\FSMClk|currentstate.clockMode~q\ & (!\FSMClk|currentstate.updateMode~q\ & (\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.preSetMode~q\))) ) ) ) # ( 
-- !\setT|outSeconds\(3) & ( \Mc|counter\(3) & ( (!\FSMClk|currentstate.clockMode~q\ & !\FSMClk|currentstate.preSetMode~q\) ) ) ) # ( \setT|outSeconds\(3) & ( !\Mc|counter\(3) & ( (!\FSMClk|currentstate.updateMode~q\ & \FSMClk|currentstate.setMode~q\) ) ) ) 
...
-- Equation(s):
-- \FSMClk|Selector5~0_combout\ = ( \setT|outSeconds\(0) & ( \Mc|counter\(0) & ( (\FSMClk|currentstate.setMode~q\ & (!\FSMClk|currentstate.clockMode~q\ & (!\FSMClk|currentstate.updateMode~q\ & !\FSMClk|currentstate.preSetMode~q\))) ) ) ) # ( 
-- !\setT|outSeconds\(0) & ( \Mc|counter\(0) & ( (!\FSMClk|currentstate.clockMode~q\ & !\FSMClk|currentstate.preSetMode~q\) ) ) ) # ( \setT|outSeconds\(0) & ( !\Mc|counter\(0) & ( (\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.updateMode~q\) ) ) ) 
...
-- Equation(s):
-- \h0|WideOr6~0_combout\ = ( \FSMClk|Selector5~0_combout\ & ( (!\FSMClk|Selector4~0_combout\) # (!\FSMClk|Selector3~0_combout\ $ (!\FSMClk|Selector2~0_combout\)) ) ) # ( !\FSMClk|Selector5~0_combout\ & ( (!\FSMClk|Selector2~0_combout\) # 
-- (!\FSMClk|Selector3~0_combout\ $ (!\FSMClk|Selector4~0_combout\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111101100110111111110110011011011101111011101101110111101110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h0|WideOr5~0_combout\ = ( \FSMClk|Selector5~0_combout\ & ( (\FSMClk|Selector3~0_combout\ & (!\FSMClk|Selector4~0_combout\ & \FSMClk|Selector2~0_combout\)) ) ) # ( !\FSMClk|Selector5~0_combout\ & ( !\FSMClk|Selector2~0_combout\ $ 
-- (((!\FSMClk|Selector4~0_combout\) # (\FSMClk|Selector3~0_combout\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010110100101101001011010010110100000100000001000000010000000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_Selector3~0_combout\,
...
-- Equation(s):
-- \h0|WideOr4~0_combout\ = ( \FSMClk|Selector5~0_combout\ & ( (\FSMClk|Selector4~0_combout\ & (!\FSMClk|Selector3~0_combout\ & \FSMClk|Selector2~0_combout\)) ) ) # ( !\FSMClk|Selector5~0_combout\ & ( ((\FSMClk|Selector4~0_combout\ & 
-- \FSMClk|Selector3~0_combout\)) # (\FSMClk|Selector2~0_combout\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001111111111000000111111111100000000001100000000000000110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \FSMClk|ALT_INV_Selector4~0_combout\,
...
-- !\FSMClk|Selector5~0_combout\ & ( (!\FSMClk|Selector4~0_combout\ & (!\FSMClk|Selector3~0_combout\ & !\FSMClk|Selector2~0_combout\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100000000000000110000000000000011110000000011001111000000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \FSMClk|ALT_INV_Selector4~0_combout\,
...
-- Equation(s):
-- \h0|WideOr0~0_combout\ = ( \FSMClk|Selector5~0_combout\ & ( (\FSMClk|Selector4~0_combout\ & (!\FSMClk|Selector3~0_combout\ & \FSMClk|Selector2~0_combout\)) ) ) # ( !\FSMClk|Selector5~0_combout\ & ( (!\FSMClk|Selector4~0_combout\ & 
-- (\FSMClk|Selector3~0_combout\ & !\FSMClk|Selector2~0_combout\)) # (\FSMClk|Selector4~0_combout\ & (!\FSMClk|Selector3~0_combout\ $ (\FSMClk|Selector2~0_combout\))) ) )
...
-- Equation(s):
-- \FSMClk|Selector0~0_combout\ = ( \FSMClk|currentstate.updateMode~q\ & ( \FSMClk|currentstate.setMode~q\ & ( ((\Mc|counter\(5) & ((\FSMClk|currentstate.preSetMode~q\) # (\FSMClk|currentstate.clockMode~q\)))) # (\setT|outSeconds\(5)) ) ) ) # ( 
-- !\FSMClk|currentstate.updateMode~q\ & ( \FSMClk|currentstate.setMode~q\ & ( (\Mc|counter\(5) & ((\FSMClk|currentstate.preSetMode~q\) # (\FSMClk|currentstate.clockMode~q\))) ) ) ) # ( \FSMClk|currentstate.updateMode~q\ & ( !\FSMClk|currentstate.setMode~q\ 
-- & ( ((\Mc|counter\(5) & ((\FSMClk|currentstate.preSetMode~q\) # (\FSMClk|currentstate.clockMode~q\)))) # (\setT|outSeconds\(5)) ) ) ) # ( !\FSMClk|currentstate.updateMode~q\ & ( !\FSMClk|currentstate.setMode~q\ & ( ((\Mc|counter\(5) & 
-- ((\FSMClk|currentstate.preSetMode~q\) # (\FSMClk|currentstate.clockMode~q\)))) # (\setT|outSeconds\(5)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001101111111001100110111111100000000010111110011001101111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_currentstate.clockMode~q\,
...
-- Equation(s):
-- \h1|Decoder0~0_combout\ = ( !\FSMClk|outhours~5_combout\ & ( \FSMClk|outhours~4_combout\ & ( (\Mc|counter\(5)) # (\Mc|counter\(4)) ) ) ) # ( \FSMClk|outhours~5_combout\ & ( !\FSMClk|outhours~4_combout\ & ( (\setT|outSeconds\(5)) # (\setT|outSeconds\(4)) ) 
-- ) ) # ( !\FSMClk|outhours~5_combout\ & ( !\FSMClk|outhours~4_combout\ & ( (((\setT|outSeconds\(5)) # (\setT|outSeconds\(4))) # (\Mc|counter\(5))) # (\Mc|counter\(4)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111111111111111000011111111111101110111011101110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \Mc|ALT_INV_counter\(4),
...
-- Equation(s):
-- \FSMClk|Selector1~0_combout\ = ( \Mc|counter\(4) & ( \FSMClk|currentstate.preSetMode~q\ ) ) # ( !\Mc|counter\(4) & ( \FSMClk|currentstate.preSetMode~q\ & ( (\setT|outSeconds\(4) & ((!\FSMClk|currentstate.setMode~q\) # 
-- (\FSMClk|currentstate.updateMode~q\))) ) ) ) # ( \Mc|counter\(4) & ( !\FSMClk|currentstate.preSetMode~q\ & ( ((\setT|outSeconds\(4) & ((!\FSMClk|currentstate.setMode~q\) # (\FSMClk|currentstate.updateMode~q\)))) # (\FSMClk|currentstate.clockMode~q\) ) ) ) 
-- # ( !\Mc|counter\(4) & ( !\FSMClk|currentstate.preSetMode~q\ & ( (\setT|outSeconds\(4) & ((!\FSMClk|currentstate.setMode~q\) # (\FSMClk|currentstate.updateMode~q\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100010001001111110001111100110011000100011111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h1|Decoder0~1_combout\ = ( !\FSMClk|outhours~5_combout\ & ( \FSMClk|outhours~4_combout\ & ( (\Mc|counter\(4) & !\Mc|counter\(5)) ) ) ) # ( \FSMClk|outhours~5_combout\ & ( !\FSMClk|outhours~4_combout\ & ( (\setT|outSeconds\(4) & !\setT|outSeconds\(5)) ) ) 
-- ) # ( !\FSMClk|outhours~5_combout\ & ( !\FSMClk|outhours~4_combout\ & ( (!\Mc|counter\(5) & (!\setT|outSeconds\(5) & ((\setT|outSeconds\(4)) # (\Mc|counter\(4))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100110000000000000011110000000001000100010001000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \Mc|ALT_INV_counter\(4),
...
-- Equation(s):
-- \h1|Decoder0~2_combout\ = ( !\FSMClk|outhours~5_combout\ & ( \FSMClk|outhours~4_combout\ & ( (!\Mc|counter\(4) & \Mc|counter\(5)) ) ) ) # ( \FSMClk|outhours~5_combout\ & ( !\FSMClk|outhours~4_combout\ & ( (!\setT|outSeconds\(4) & \setT|outSeconds\(5)) ) ) 
-- ) # ( !\FSMClk|outhours~5_combout\ & ( !\FSMClk|outhours~4_combout\ & ( (!\Mc|counter\(4) & (!\setT|outSeconds\(4) & ((\setT|outSeconds\(5)) # (\Mc|counter\(5))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010000010100000000000001111000000100010001000100000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \Mc|ALT_INV_counter\(4),
...
-- Equation(s):
-- \Hc|Add0~0_combout\ = ( \Hc|counter\(2) & ( !\Hc|counter\(3) $ (((!\Hc|counter\(0)) # (!\Hc|counter\(1)))) ) ) # ( !\Hc|counter\(2) & ( \Hc|counter\(3) ) )
...
-- Equation(s):
-- \Hc|counter~3_combout\ = ( \FSMClk|update~combout\ & ( \setT|outMinutes\(3) ) ) # ( !\FSMClk|update~combout\ & ( (!\Hc|pulse~0_combout\ & (\Hc|Add0~0_combout\ & \KEY[0]~input_o\)) ) )
...
-- Equation(s):
-- \Hc|Add0~1_combout\ = ( \Hc|counter\(1) & ( (\Hc|counter\(2) & (\Hc|counter\(0) & (\Hc|counter\(3) & \Hc|counter\(4)))) ) )
...
-- Equation(s):
-- \Hc|counter~4_combout\ = ( \Hc|counter\(5) & ( \FSMClk|update~combout\ & ( \setT|outMinutes\(5) ) ) ) # ( !\Hc|counter\(5) & ( \FSMClk|update~combout\ & ( \setT|outMinutes\(5) ) ) ) # ( \Hc|counter\(5) & ( !\FSMClk|update~combout\ & ( 
-- (!\Hc|Add0~1_combout\ & (!\Hc|pulse~0_combout\ & \KEY[0]~input_o\)) ) ) ) # ( !\Hc|counter\(5) & ( !\FSMClk|update~combout\ & ( (\Hc|Add0~1_combout\ & (!\Hc|pulse~0_combout\ & \KEY[0]~input_o\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001010000000000001010000000110011001100110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \setT|outMinutes~6_combout\ = ( \setT|outMinutes\(5) & ( \setT|outMinutes~8_combout\ & ( (!\KEY[2]~input_o\ & ((!\setT|outMinutes\(0)) # (!\setT|outMinutes\(1)))) ) ) ) # ( !\setT|outMinutes\(5) & ( \setT|outMinutes~8_combout\ & ( (!\KEY[2]~input_o\ & 
-- (\setT|outMinutes\(0) & (\setT|outMinutes\(2) & \setT|outMinutes\(1)))) ) ) ) # ( \setT|outMinutes\(5) & ( !\setT|outMinutes~8_combout\ ) ) # ( !\setT|outMinutes\(5) & ( !\setT|outMinutes~8_combout\ & ( \KEY[2]~input_o\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101111111111111111100000000000000101010101010001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_KEY[2]~input_o\,
...
-- Equation(s):
-- \setT|outMinutes[4]~3_combout\ = ( !\setT|outMinutes\(2) & ( (\setT|outMinutes\(3) & (!\KEY[2]~input_o\ & (\setT|outMinutes\(4) & \setT|outMinutes\(5)))) ) )
...
-- (((!\setT|outMinutes\(2)) # (!\setT|Add1~0_combout\)))) # (\KEY[2]~input_o\) ) ) ) # ( \setT|outMinutes[4]~3_combout\ & ( !\Hc|counter\(3) & ( (!\KEY[2]~input_o\ & (\setT|outMinutes\(3) & !\setT|Add1~0_combout\)) ) ) ) # ( !\setT|outMinutes[4]~3_combout\ 
-- & ( !\Hc|counter\(3) & ( (!\KEY[2]~input_o\ & (!\setT|outMinutes\(3) $ (((!\setT|outMinutes\(2)) # (!\setT|Add1~0_combout\))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110001001000000011000000000000111111011110110011111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \setT|outMinutes~9_combout\ = ( \setT|outMinutes\(2) & ( \Hc|counter\(4) & ( (!\setT|outMinutes\(4)) # (\KEY[2]~input_o\) ) ) ) # ( !\setT|outMinutes\(2) & ( \Hc|counter\(4) & ( ((\setT|outMinutes\(4) & !\setT|outMinutes\(5))) # (\KEY[2]~input_o\) ) ) ) # 
-- ( \setT|outMinutes\(2) & ( !\Hc|counter\(4) & ( (!\KEY[2]~input_o\ & !\setT|outMinutes\(4)) ) ) ) # ( !\setT|outMinutes\(2) & ( !\Hc|counter\(4) & ( (!\KEY[2]~input_o\ & (\setT|outMinutes\(4) & !\setT|outMinutes\(5))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110000000000110000001100000000111111001100111111001111110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_KEY[2]~input_o\,
...
-- Equation(s):
-- \setT|outMinutes~7_combout\ = ( \setT|outMinutes\(3) & ( \setT|outMinutes~9_combout\ & ( (((\setT|outMinutes\(0) & \setT|outMinutes\(1))) # (\KEY[2]~input_o\)) # (\setT|outMinutes\(4)) ) ) ) # ( !\setT|outMinutes\(3) & ( \setT|outMinutes~9_combout\ & ( 
-- (\KEY[2]~input_o\) # (\setT|outMinutes\(4)) ) ) ) # ( \setT|outMinutes\(3) & ( !\setT|outMinutes~9_combout\ & ( (\setT|outMinutes\(4) & (!\KEY[2]~input_o\ & ((!\setT|outMinutes\(0)) # (!\setT|outMinutes\(1))))) ) ) ) # ( !\setT|outMinutes\(3) & ( 
-- !\setT|outMinutes~9_combout\ & ( (\setT|outMinutes\(4) & !\KEY[2]~input_o\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101000001010000010100000100000001011111010111110101111101111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \Hc|Add0~2_combout\ = ( \Hc|counter\(1) & ( !\Hc|counter\(4) $ (((!\Hc|counter\(2)) # ((!\Hc|counter\(0)) # (!\Hc|counter\(3))))) ) ) # ( !\Hc|counter\(1) & ( \Hc|counter\(4) ) )
...
-- Equation(s):
-- \Hc|counter~5_combout\ = ( \Hc|Add0~2_combout\ & ( (!\FSMClk|update~combout\ & (((\KEY[0]~input_o\ & !\Hc|pulse~0_combout\)))) # (\FSMClk|update~combout\ & (\setT|outMinutes\(4))) ) ) # ( !\Hc|Add0~2_combout\ & ( (\FSMClk|update~combout\ & 
-- \setT|outMinutes\(4)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000100010001000100010001000100011011000100010001101100010001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	dataf => \Hc|ALT_INV_Add0~2_combout\,
...
-- Equation(s):
-- \Hc|pulse~0_combout\ = ( \Hc|counter\(3) & ( \Hc|counter\(1) & ( (\Hc|counter\(0) & (\Hc|counter\(4) & (!\Hc|counter\(2) & \Hc|counter\(5)))) ) ) )
...
-- Equation(s):
-- \Hc|counter~2_combout\ = ( \Hc|counter\(1) & ( \Hc|counter\(0) & ( (\setT|outMinutes\(1) & \FSMClk|update~combout\) ) ) ) # ( !\Hc|counter\(1) & ( \Hc|counter\(0) & ( (!\FSMClk|update~combout\ & (((!\Hc|pulse~0_combout\ & \KEY[0]~input_o\)))) # 
-- (\FSMClk|update~combout\ & (\setT|outMinutes\(1))) ) ) ) # ( \Hc|counter\(1) & ( !\Hc|counter\(0) & ( (!\FSMClk|update~combout\ & (((!\Hc|pulse~0_combout\ & \KEY[0]~input_o\)))) # (\FSMClk|update~combout\ & (\setT|outMinutes\(1))) ) ) ) # ( 
-- !\Hc|counter\(1) & ( !\Hc|counter\(0) & ( (\setT|outMinutes\(1) & \FSMClk|update~combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000100010001000100011101000100010001110100010001000100010001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \setT|outMinutes~2_combout\ = ( \setT|outMinutes\(0) & ( \Hc|counter\(1) & ( (!\setT|outMinutes\(1)) # (\KEY[2]~input_o\) ) ) ) # ( !\setT|outMinutes\(0) & ( \Hc|counter\(1) & ( (\setT|outMinutes\(1)) # (\KEY[2]~input_o\) ) ) ) # ( \setT|outMinutes\(0) & 
-- ( !\Hc|counter\(1) & ( (!\KEY[2]~input_o\ & !\setT|outMinutes\(1)) ) ) ) # ( !\setT|outMinutes\(0) & ( !\Hc|counter\(1) & ( (!\KEY[2]~input_o\ & \setT|outMinutes\(1)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011110000111100000000000000001111111111111111111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datac => \ALT_INV_KEY[2]~input_o\,
...
-- Equation(s):
-- \setT|outMinutes~4_combout\ = ( \Hc|counter\(2) & ( (!\setT|Add1~0_combout\ & (((\setT|outMinutes\(2))) # (\KEY[2]~input_o\))) # (\setT|Add1~0_combout\ & (!\setT|outMinutes[4]~3_combout\ & ((!\setT|outMinutes\(2)) # (\KEY[2]~input_o\)))) ) ) # ( 
-- !\Hc|counter\(2) & ( (!\KEY[2]~input_o\ & ((!\setT|Add1~0_combout\ & (\setT|outMinutes\(2))) # (\setT|Add1~0_combout\ & (!\setT|outMinutes\(2) & !\setT|outMinutes[4]~3_combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010100000001000001010000000100001111101010011000111110101001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_KEY[2]~input_o\,
...
-- Equation(s):
-- \FSMClk|Selector9~0_combout\ = ( \setT|outMinutes\(2) & ( \Hc|counter\(2) & ( (!\FSMClk|currentstate.clockMode~q\ & (!\FSMClk|currentstate.updateMode~q\ & (!\FSMClk|currentstate.preSetMode~q\ & \FSMClk|currentstate.setMode~q\))) ) ) ) # ( 
...
-- Equation(s):
-- \FSMClk|Selector8~0_combout\ = ( \setT|outMinutes\(3) & ( \Hc|counter\(3) & ( (!\FSMClk|currentstate.clockMode~q\ & (!\FSMClk|currentstate.updateMode~q\ & (\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.preSetMode~q\))) ) ) ) # ( 
...
-- Equation(s):
-- \h2|WideOr6~0_combout\ = ( \FSMClk|Selector10~0_combout\ & ( \FSMClk|Selector8~0_combout\ & ( !\FSMClk|Selector9~0_combout\ ) ) ) # ( !\FSMClk|Selector10~0_combout\ & ( \FSMClk|Selector8~0_combout\ & ( (\FSMClk|Selector11~0_combout\) # 
-- (\FSMClk|Selector9~0_combout\) ) ) ) # ( \FSMClk|Selector10~0_combout\ & ( !\FSMClk|Selector8~0_combout\ & ( (!\FSMClk|Selector11~0_combout\) # (\FSMClk|Selector9~0_combout\) ) ) ) # ( !\FSMClk|Selector10~0_combout\ & ( !\FSMClk|Selector8~0_combout\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111101011111010101011111010111111010101010101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h2|WideOr5~0_combout\ = ( \FSMClk|Selector10~0_combout\ & ( \FSMClk|Selector8~0_combout\ & ( (\FSMClk|Selector9~0_combout\ & !\FSMClk|Selector11~0_combout\) ) ) ) # ( !\FSMClk|Selector10~0_combout\ & ( \FSMClk|Selector8~0_combout\ & ( 
-- (!\FSMClk|Selector11~0_combout\) # (\FSMClk|Selector9~0_combout\) ) ) ) # ( \FSMClk|Selector10~0_combout\ & ( !\FSMClk|Selector8~0_combout\ & ( (!\FSMClk|Selector9~0_combout\ & !\FSMClk|Selector11~0_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101000001010000011110101111101010101000001010000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_Selector9~0_combout\,
...
-- Equation(s):
-- \h2|WideOr4~0_combout\ = ( \FSMClk|Selector9~0_combout\ & ( (!\FSMClk|Selector11~0_combout\ & ((\FSMClk|Selector10~0_combout\) # (\FSMClk|Selector8~0_combout\))) ) ) # ( !\FSMClk|Selector9~0_combout\ & ( (\FSMClk|Selector8~0_combout\ & 
-- ((!\FSMClk|Selector11~0_combout\) # (\FSMClk|Selector10~0_combout\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100010101000101010001010100010101001100010011000100110001001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h2|WideOr3~0_combout\ = ( \FSMClk|Selector10~0_combout\ & ( \FSMClk|Selector8~0_combout\ & ( !\FSMClk|Selector9~0_combout\ $ (!\FSMClk|Selector11~0_combout\) ) ) ) # ( !\FSMClk|Selector10~0_combout\ & ( \FSMClk|Selector8~0_combout\ & ( 
-- (!\FSMClk|Selector9~0_combout\ & !\FSMClk|Selector11~0_combout\) ) ) ) # ( !\FSMClk|Selector10~0_combout\ & ( !\FSMClk|Selector8~0_combout\ & ( !\FSMClk|Selector9~0_combout\ $ (\FSMClk|Selector11~0_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010010110100101000000000000000010100000101000000101101001011010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_Selector9~0_combout\,
...
PORT MAP (
	dataa => \FSMClk|ALT_INV_Selector9~0_combout\,
	datab => \FSMClk|ALT_INV_Selector11~0_combout\,
	datad => \FSMClk|ALT_INV_Selector10~0_combout\,
	dataf => \FSMClk|ALT_INV_Selector8~0_combout\,
...
-- Equation(s):
-- \h2|WideOr0~0_combout\ = ( \FSMClk|Selector8~0_combout\ & ( (\FSMClk|Selector10~0_combout\ & (!\FSMClk|Selector9~0_combout\ $ (!\FSMClk|Selector11~0_combout\))) ) ) # ( !\FSMClk|Selector8~0_combout\ & ( (!\FSMClk|Selector11~0_combout\ & 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011101110111011000010101010101011111111111111110000101010101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h3|Decoder0~1_combout\ = ( \Hc|counter\(4) & ( \FSMClk|outhours~4_combout\ & ( (!\Hc|counter\(5) & !\FSMClk|outhours~5_combout\) ) ) ) # ( \Hc|counter\(4) & ( !\FSMClk|outhours~4_combout\ & ( (!\setT|outMinutes\(5) & ((!\FSMClk|outhours~5_combout\ & 
-- ((!\Hc|counter\(5)))) # (\FSMClk|outhours~5_combout\ & (\setT|outMinutes\(4))))) ) ) ) # ( !\Hc|counter\(4) & ( !\FSMClk|outhours~4_combout\ & ( (\setT|outMinutes\(4) & (!\setT|outMinutes\(5) & ((!\Hc|counter\(5)) # (\FSMClk|outhours~5_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100000001010000110000000101000000000000000000001100110000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \setT|ALT_INV_outMinutes\(4),
...
-- Equation(s):
-- \h3|Decoder0~2_combout\ = ( \setT|outMinutes\(5) & ( \FSMClk|outhours~4_combout\ & ( (\Hc|counter\(5) & (!\Hc|counter\(4) & !\FSMClk|outhours~5_combout\)) ) ) ) # ( !\setT|outMinutes\(5) & ( \FSMClk|outhours~4_combout\ & ( (\Hc|counter\(5) & 
-- (!\Hc|counter\(4) & !\FSMClk|outhours~5_combout\)) ) ) ) # ( \setT|outMinutes\(5) & ( !\FSMClk|outhours~4_combout\ & ( (!\setT|outMinutes\(4) & ((!\Hc|counter\(4)) # (\FSMClk|outhours~5_combout\))) ) ) ) # ( !\setT|outMinutes\(5) & ( 
-- !\FSMClk|outhours~4_combout\ & ( (\Hc|counter\(5) & (!\Hc|counter\(4) & (!\setT|outMinutes\(4) & !\FSMClk|outhours~5_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100000000000000110000001111000001000100000000000100010000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
\H|hours[4]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \H|hours[4]~1_combout\ = ( \FSMClk|update~combout\ ) # ( !\FSMClk|update~combout\ & ( (!\KEY[0]~input_o\) # (\Hc|pulse~q\) ) )
...
\setT|outHours[2]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \setT|outHours[2]~1_combout\ = ( \FSMClk|setInitVal~combout\ ) # ( !\FSMClk|setInitVal~combout\ & ( !\KEY[3]~input_o\ ) )
...
PORT MAP (
	datab => \ALT_INV_KEY[3]~input_o\,
	dataf => \FSMClk|ALT_INV_setInitVal~combout\,
	combout => \setT|outHours[2]~1_combout\);
...
-- Equation(s):
-- \H|hours~7_combout\ = ( !\FSMClk|update~combout\ & ( (!\H|hours[4]~2_combout\ & (\KEY[0]~input_o\ & (!\H|hours\(2) $ (((!\H|hours\(0)) # (!\H|hours\(1))))))) ) ) # ( \FSMClk|update~combout\ & ( (((\setT|outHours\(2)))) ) )
...
PORT MAP (
	...
	datab => \H|ALT_INV_hours[4]~2_combout\,
...
\setT|outHours[2]~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \setT|outHours[2]~4_combout\ = ( \setT|outHours\(1) & ( (\setT|outHours\(0) & \setT|outHours\(2)) ) )
...
PORT MAP (
	...
	combout => \setT|outHours[2]~4_combout\);

-- Location: LABCELL_X88_Y9_N21
\H|hours[4]~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \H|hours[4]~4_combout\ = (\H|hours\(1) & (\H|hours\(0) & \H|hours\(2)))
...
PORT MAP (
	...
	combout => \H|hours[4]~4_combout\);

-- Location: LABCELL_X88_Y9_N48
\H|hours~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \H|hours~5_combout\ = ( \H|hours\(3) & ( \setT|outHours\(3) & ( ((\KEY[0]~input_o\ & !\H|hours[4]~4_combout\)) # (\FSMClk|update~combout\) ) ) ) # ( !\H|hours\(3) & ( \setT|outHours\(3) & ( ((\KEY[0]~input_o\ & (\H|hours[4]~4_combout\ & !\H|hours\(4)))) # 
-- (\FSMClk|update~combout\) ) ) ) # ( \H|hours\(3) & ( !\setT|outHours\(3) & ( (!\FSMClk|update~combout\ & (\KEY[0]~input_o\ & !\H|hours[4]~4_combout\)) ) ) ) # ( !\H|hours\(3) & ( !\setT|outHours\(3) & ( (!\FSMClk|update~combout\ & (\KEY[0]~input_o\ & 
-- (\H|hours[4]~4_combout\ & !\H|hours\(4)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001000000000001000000010000001010111010101010111010101110101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_update~combout\,
	datab => \ALT_INV_KEY[0]~input_o\,
	datac => \H|ALT_INV_hours[4]~4_combout\,
...
-- Equation(s):
-- \setT|outHours~5_combout\ = ( \H|hours\(3) & ( ((!\setT|outHours[2]~4_combout\ & ((\setT|outHours\(3)))) # (\setT|outHours[2]~4_combout\ & (!\setT|outHours\(4) & !\setT|outHours\(3)))) # (\KEY[3]~input_o\) ) ) # ( !\H|hours\(3) & ( (!\KEY[3]~input_o\ & 
-- ((!\setT|outHours[2]~4_combout\ & ((\setT|outHours\(3)))) # (\setT|outHours[2]~4_combout\ & (!\setT|outHours\(4) & !\setT|outHours\(3))))) ) )
...
PORT MAP (
	...
	datab => \setT|ALT_INV_outHours[2]~4_combout\,
...
-- Equation(s):
-- \setT|outHours~6_combout\ = ( \H|hours\(4) & ( ((!\setT|outHours[2]~4_combout\ & ((\setT|outHours\(4)))) # (\setT|outHours[2]~4_combout\ & (\setT|outHours\(3) & !\setT|outHours\(4)))) # (\KEY[3]~input_o\) ) ) # ( !\H|hours\(4) & ( (!\KEY[3]~input_o\ & 
-- ((!\setT|outHours[2]~4_combout\ & ((\setT|outHours\(4)))) # (\setT|outHours[2]~4_combout\ & (\setT|outHours\(3) & !\setT|outHours\(4))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010011000000000001001100000000110111111100110011011111110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \setT|ALT_INV_outHours\(3),
	datab => \ALT_INV_KEY[3]~input_o\,
	datac => \setT|ALT_INV_outHours[2]~4_combout\,
...
-- Equation(s):
-- \H|hours~6_combout\ = ( \H|hours\(4) & ( \H|hours\(3) & ( (!\FSMClk|update~combout\ & (((!\H|hours[4]~4_combout\ & \KEY[0]~input_o\)))) # (\FSMClk|update~combout\ & (\setT|outHours\(4))) ) ) ) # ( !\H|hours\(4) & ( \H|hours\(3) & ( 
-- (!\FSMClk|update~combout\ & (((\H|hours[4]~4_combout\ & \KEY[0]~input_o\)))) # (\FSMClk|update~combout\ & (\setT|outHours\(4))) ) ) ) # ( \H|hours\(4) & ( !\H|hours\(3) & ( (!\FSMClk|update~combout\ & (((!\H|hours[4]~4_combout\ & \KEY[0]~input_o\)))) # 
-- (\FSMClk|update~combout\ & (\setT|outHours\(4))) ) ) ) # ( !\H|hours\(4) & ( !\H|hours\(3) & ( (\FSMClk|update~combout\ & \setT|outHours\(4)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000100010001000100011011000100010001000110110001000110110001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_update~combout\,
...
\H|hours[4]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \H|hours[4]~2_combout\ = ( \H|hours\(1) & ( (\H|hours\(2) & (\H|hours\(0) & (\H|hours\(4) & !\H|hours\(3)))) ) )
...
PORT MAP (
	...
	dataf => \H|ALT_INV_hours\(1),
	combout => \H|hours[4]~2_combout\);

-- Location: LABCELL_X88_Y9_N30
\H|hours~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \H|hours~3_combout\ = ( \H|hours\(1) & ( \FSMClk|update~combout\ & ( \setT|outHours\(1) ) ) ) # ( !\H|hours\(1) & ( \FSMClk|update~combout\ & ( \setT|outHours\(1) ) ) ) # ( \H|hours\(1) & ( !\FSMClk|update~combout\ & ( (!\H|hours[4]~2_combout\ & 
-- (!\H|hours\(0) & \KEY[0]~input_o\)) ) ) ) # ( !\H|hours\(1) & ( !\FSMClk|update~combout\ & ( (!\H|hours[4]~2_combout\ & (\H|hours\(0) & \KEY[0]~input_o\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001010000000001010000000110011001100110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \H|ALT_INV_hours[4]~2_combout\,
...
-- Equation(s):
-- \FSMClk|Selector15~0_combout\ = ( \FSMClk|currentstate.preSetMode~q\ & ( \setT|outHours\(1) & ( (\FSMClk|currentstate.setMode~q\ & (!\FSMClk|currentstate.updateMode~q\ & !\H|hours\(1))) ) ) ) # ( !\FSMClk|currentstate.preSetMode~q\ & ( \setT|outHours\(1) 
-- & ( (\FSMClk|currentstate.setMode~q\ & (!\FSMClk|currentstate.updateMode~q\ & ((!\FSMClk|currentstate.clockMode~q\) # (!\H|hours\(1))))) ) ) ) # ( \FSMClk|currentstate.preSetMode~q\ & ( !\setT|outHours\(1) & ( !\H|hours\(1) ) ) ) # ( 
-- !\FSMClk|currentstate.preSetMode~q\ & ( !\setT|outHours\(1) & ( (!\FSMClk|currentstate.clockMode~q\) # (!\H|hours\(1)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111110000111111110000000001000100010000000100010000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_currentstate.setMode~q\,
...
-- Equation(s):
-- \FSMClk|Selector16~0_combout\ = ( \FSMClk|currentstate.clockMode~q\ & ( \FSMClk|currentstate.preSetMode~q\ & ( (!\H|hours\(0) & ((!\setT|outHours\(0)) # ((\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.updateMode~q\)))) ) ) ) # ( 
-- !\FSMClk|currentstate.clockMode~q\ & ( \FSMClk|currentstate.preSetMode~q\ & ( (!\H|hours\(0) & ((!\setT|outHours\(0)) # ((\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.updateMode~q\)))) ) ) ) # ( \FSMClk|currentstate.clockMode~q\ & ( 
-- !\FSMClk|currentstate.preSetMode~q\ & ( (!\H|hours\(0) & ((!\setT|outHours\(0)) # ((\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.updateMode~q\)))) ) ) ) # ( !\FSMClk|currentstate.clockMode~q\ & ( !\FSMClk|currentstate.preSetMode~q\ & ( 
-- (!\setT|outHours\(0)) # ((\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.updateMode~q\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010111110101010100011001000100010001100100010001000110010001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \setT|ALT_INV_outHours\(0),
...
-- Equation(s):
-- \FSMClk|Selector14~0_combout\ = ( \setT|outHours\(2) & ( \FSMClk|currentstate.clockMode~q\ & ( (!\H|hours\(2) & (\FSMClk|currentstate.setMode~q\ & !\FSMClk|currentstate.updateMode~q\)) ) ) ) # ( !\setT|outHours\(2) & ( \FSMClk|currentstate.clockMode~q\ & 
-- ( !\H|hours\(2) ) ) ) # ( \setT|outHours\(2) & ( !\FSMClk|currentstate.clockMode~q\ & ( (\FSMClk|currentstate.setMode~q\ & (!\FSMClk|currentstate.updateMode~q\ & ((!\H|hours\(2)) # (!\FSMClk|currentstate.preSetMode~q\)))) ) ) ) # ( !\setT|outHours\(2) & ( 
-- !\FSMClk|currentstate.clockMode~q\ & ( (!\H|hours\(2)) # (!\FSMClk|currentstate.preSetMode~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111110101010001100000010000010101010101010100010000000100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \H|ALT_INV_hours\(2),
...
-- Equation(s):
-- \FSMClk|Selector13~0_combout\ = ( !\setT|outHours\(3) & ( \FSMClk|currentstate.updateMode~q\ & ( (!\H|hours\(3)) # ((!\FSMClk|currentstate.clockMode~q\ & !\FSMClk|currentstate.preSetMode~q\)) ) ) ) # ( \setT|outHours\(3) & ( 
-- !\FSMClk|currentstate.updateMode~q\ & ( (\FSMClk|currentstate.setMode~q\ & ((!\H|hours\(3)) # ((!\FSMClk|currentstate.clockMode~q\ & !\FSMClk|currentstate.preSetMode~q\)))) ) ) ) # ( !\setT|outHours\(3) & ( !\FSMClk|currentstate.updateMode~q\ & ( 
-- (!\H|hours\(3)) # ((!\FSMClk|currentstate.clockMode~q\ & !\FSMClk|currentstate.preSetMode~q\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111101010101010001100100010001011111010101010100000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h4|WideOr6~0_combout\ = ( \FSMClk|Selector13~0_combout\ & ( (!\FSMClk|Selector15~0_combout\ & ((\FSMClk|Selector14~0_combout\) # (\FSMClk|Selector16~0_combout\))) # (\FSMClk|Selector15~0_combout\ & ((!\FSMClk|Selector14~0_combout\))) ) ) # ( 
-- !\FSMClk|Selector13~0_combout\ & ( (!\FSMClk|Selector15~0_combout\) # ((!\FSMClk|Selector16~0_combout\) # (\FSMClk|Selector14~0_combout\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111101011111111111110101111111101011111101010100101111110101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h4|WideOr5~0_combout\ = ( \FSMClk|Selector16~0_combout\ & ( (!\FSMClk|Selector15~0_combout\ & (\FSMClk|Selector13~0_combout\ & \FSMClk|Selector14~0_combout\)) ) ) # ( !\FSMClk|Selector16~0_combout\ & ( !\FSMClk|Selector13~0_combout\ $ 
...
-- Equation(s):
-- \h4|WideOr4~0_combout\ = ( \FSMClk|Selector13~0_combout\ & ( (!\FSMClk|Selector16~0_combout\) # ((\FSMClk|Selector15~0_combout\ & !\FSMClk|Selector14~0_combout\)) ) ) # ( !\FSMClk|Selector13~0_combout\ & ( (\FSMClk|Selector15~0_combout\ & 
-- (!\FSMClk|Selector16~0_combout\ & \FSMClk|Selector14~0_combout\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001010000000000000101000011110101111100001111010111110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \FSMClk|ALT_INV_Selector15~0_combout\,
...
-- Equation(s):
-- \h4|WideOr3~0_combout\ = ( \FSMClk|Selector16~0_combout\ & ( (!\FSMClk|Selector15~0_combout\ & (!\FSMClk|Selector13~0_combout\ & \FSMClk|Selector14~0_combout\)) # (\FSMClk|Selector15~0_combout\ & (\FSMClk|Selector13~0_combout\ & 
-- !\FSMClk|Selector14~0_combout\)) ) ) # ( !\FSMClk|Selector16~0_combout\ & ( (!\FSMClk|Selector15~0_combout\ & ((!\FSMClk|Selector14~0_combout\))) # (\FSMClk|Selector15~0_combout\ & (\FSMClk|Selector13~0_combout\ & \FSMClk|Selector14~0_combout\)) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111001111000000001111000000000011110011110000000011110000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \h4|WideOr0~0_combout\ = ( \FSMClk|Selector16~0_combout\ & ( (\FSMClk|Selector15~0_combout\ & (\FSMClk|Selector13~0_combout\ & !\FSMClk|Selector14~0_combout\)) ) ) # ( !\FSMClk|Selector16~0_combout\ & ( (!\FSMClk|Selector15~0_combout\ & 
-- (!\FSMClk|Selector13~0_combout\ & \FSMClk|Selector14~0_combout\)) # (\FSMClk|Selector15~0_combout\ & (!\FSMClk|Selector13~0_combout\ $ (\FSMClk|Selector14~0_combout\))) ) )
